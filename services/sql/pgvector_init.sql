...
INSERT INTO model_registry (model_name, display_name, category, factor_keys, factor_dim) VALUES
    ...
    ('cb_auction_t0_v2',    '竞价选债 T+0 优化版 V2.0', '竞价', ARRAY['fd_amount_yi','auction_strength','concept_strength','quality_tier','theme_score','matched_concept_count','trigger_stock_count','risk_notes'], 8),
    ('cb_auction_t0_v2_1',  '竞价选债 T+0 优化版 V2.1 稳健版', '竞价', ARRAY['fd_amount_yi','auction_strength','concept_strength','quality_tier','theme_score','matched_concept_count','trigger_stock_count','risk_notes','rolling_weak_concept'], 8),
