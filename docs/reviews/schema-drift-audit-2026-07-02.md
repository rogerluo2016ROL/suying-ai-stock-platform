# Schema Drift Audit Report — 2026-07-02
**ADR-014 | UAT PG(16432) read-only**

## §1 审计范围

- DB 320张 | init_sql 75张 | 审计 107张 | 排除 22张
...
|21|`cyq_chips`|8|4|medium|=|y|
|22|`daily_basic`|12|8|medium|=|y|
|23|`daily_kline`|16|12|medium|=|y|
|24|`daily_kline_intraday`|11|11|low|=||
|25|`dc_concept`|16|0|low|init||
|26|`dc_hot`|13|0|low|init||
|27|`dc_member`|7|0|low|init||
|28|`decision_contexts`|12|0|low|init||
|29|`dividend_data`|9|5|low|=|y|
|30|`experiments`|4|0|low|init||
|31|`fina_audit`|7|7|low|=|y|
|32|`fina_mainbz`|6|6|low|=|y|
|33|`financial_abstracts`|3|3|low|=||
|34|`financial_balance`|10|6|low|=|y|
|35|`financial_cashflow`|10|6|low|=|y|
|36|`financial_income`|11|7|low|=|y|
|37|`financial_indicator`|16|12|low|=|y|
|38|`forecast_data`|8|4|low|=|y|
|39|`hk_holdings`|8|4|medium|=|y|
|40|`index_basic`|8|4|low|=||
|41|`index_daily`|13|9|medium|=|y|
|42|`industry_themes`|7|0|low|init||
|43|`interact_qa`|7|7|low|=|y|
|44|`kpl_concept_cons`|10|0|low|init||
|45|`kpl_list`|27|0|low|init||
|46|`kpl_list_ths`|21|0|low|init||
|47|`limit_cpt_list`|12|0|low|init||
|48|`limit_list_d`|28|24|high|=|y|
|49|`limit_list_d_2026_null_backup_20260630`|24|0|low|init||
|50|`limit_list_ths`|21|0|low|init||
|51|`limit_step`|7|0|low|init||
|52|`manual_overrides`|6|0|low|init||
|53|`margin_detail`|12|8|medium|=|y|
|54|`margin_summary`|3|3|medium|=|y|
|55|`membership_events`|11|0|low|init||
|56|`memberships`|13|0|low|init||
|57|`metrics`|4|0|low|init||
|58|`model_versions`|8|0|low|init||
|59|`moneyflow`|15|11|medium|=|y|
|60|`moneyflow_hsgt`|13|9|medium|=|y|
|61|`monthly_kline`|13|9|low|=|y|
|62|`mp_report`|6|6|low|=|y|
|63|`params`|3|0|low|init||
|64|`pledge_detail`|6|6|low|=|y|
|65|`policy_interpretations`|8|0|low|init||
|66|`policy_law`|8|8|low|=|y|
|67|`policy_sources`|8|0|low|init||
|68|`policy_themes`|5|0|low|init||
|69|`profit_forecasts`|5|5|low|=||
|70|`repurchase`|4|4|low|=|y|
|71|`research_reports`|6|6|low|=||
|72|`research_reports_tushare`|10|6|low|=|y|
|73|`risk_verdicts`|15|0|low|init||
|74|`role_permissions`|6|0|low|init||
|75|`rt_k`|12|12|medium|=|y|
|76|`rt_sw_k`|15|11|medium|=|y|
|77|`runs`|13|0|low|init||
|78|`screening_models`|7|0|low|init||
|79|`share_float`|4|4|low|=|y|
|80|`st_history`|5|5|low|=||
|81|`stk_auction_o`|15|10|medium|=||
|82|`stk_factor_pro`|25|21|medium|=|y|
|83|`stk_holdernumber`|3|3|low|=|y|
|84|`stk_holdertrade`|7|7|low|=|y|
|85|`stk_limit`|10|6|medium|=|y|
|86|`stk_mins`|14|10|high|=|y|
|87|`stock_news`|5|5|low|=||
|88|`stock_news_tushare`|9|5|low|=|y|
|89|`stock_profiles`|16|16|low|=|y|
|90|`stocks`|15|11|low|=|y|
|91|`strategy_plans`|16|16|high|=||
|92|`supply_chain_bom_edges`|4|0|low|init||
|93|`supply_chain_bom_nodes`|9|0|low|init||
|94|`supply_chain_scores`|9|0|low|init||
|95|`sw_daily`|19|15|medium|=|y|
|96|`sync_schedules`|10|0|low|init||
|97|`tags`|3|0|low|init||
|98|`tenants`|6|0|low|init||
|99|`ths_concept_map`|4|5|high|=||
|100|`ths_hot`|14|0|low|init||
|101|`ths_index`|6|0|low|init||
|102|`ths_member`|12|0|low|init||
|103|`top_list`|15|11|medium|=|y|
|104|`trade_cal`|3|3|low|=|y|
|105|`trade_orders`|17|0|low|init||
|106|`tushare_api_update_metadata`|7|7|high|=||
|107|`weekly_kline`|13|9|low|=|y|

## §2 严重度详情

### `candidate_pools` — high MON=no

- 类型(11): data_scope(character varying/varchar(20));source_module(character varying/varchar(40));account_id(character varying/varchar(100));name(character varying/varchar(120));created_at(timestamp with time zone/timestamptz);owner_user_id(character varying/varchar(64));tenant_id(character varying/varchar(100));updated_at(timestamp with time zone/timestamptz);pool_id(character varying/varchar(100));source_mode(character varying/varchar(60));visibility(character varying/varchar(20))
...
- 类型(13): model_name(character varying/varchar(80));data_scope(character varying/varchar(20));account_id(character varying/varchar(100));name(character varying/varchar(120));created_at(timestamp with time zone/timestamptz);plan_id(character varying/varchar(100));owner_user_id(character varying/varchar(64));tenant_id(character varying/varchar(100));single_max_pct(numeric/numeric(8,4));updated_at(timestamp with time zone/timestamptz);capital(numeric/numeric(18,2));status(character varying/varchar(30));visibility(character varying/varchar(20))
...
### `tushare_api_update_metadata` — high MON=no

- 类型(1): updated_at(timestamp with time zone/timestamptz)
...
- DB列28 vs init_sql24 | 涉及下游(MONITORED): yes
- 关键 diff: 仅DB[1]: limit
...
### ADR-14.3: `stk_mins`
- DB列14 vs init_sql10 | 涉及下游(MONITORED): yes
...
- 关键 diff: 类型(13): model_name(character varying/varchar(80));data_scope(character varying/varchar(20));account_id(character varying/varchar(100));name(character varying/varchar(120));created_at(timestamp with time zone/timestamptz);plan_id(character varying/varchar(100));owner_user_id(character varying/varchar(64));tenant_id(character varying/varchar(100));single_max_pct(numeric/numeric(8,4));updated_at(timestamp with time zone/timestamptz);capital(numeric/numeric(18,2));status(character varying/varchar(30));visibility(character varying/varchar(20))
- 建议: 按 ADR-008~013 同型骨架拆子 ADR (sync 函数对账 + init_sql 反向追认 + alembic 迁移)
...
### ADR-14.6: `tushare_api_update_metadata`
- DB列7 vs init_sql7 | 涉及下游(MONITORED): no
- 关键 diff: 类型(1): updated_at(timestamp with time zone/timestamptz)
- 建议: 按 ADR-008~013 同型骨架拆子 ADR (sync 函数对账 + init_sql 反向追认 + alembic 迁移)
