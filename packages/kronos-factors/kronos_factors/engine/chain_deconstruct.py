...
BOM_COMPLETION_PROFILES: dict[str, dict[str, list[str] | str]] = {
    ...
    # ── 六张网（2026-04-28 中央政治局会议，十五五头号工程）──
    "国家水网": {
        "chain": "国家水网产业链",
        "segments": ["建材与管材", "水利装备", "工程建设", "水务运营", "智慧水务"],
        "bom_nodes": ["PCCP/球墨铸铁管", "水泵/阀门", "盾构/TBM掘进机", "水表与流量计", "数字孪生流域平台"],
        "technologies": ["引调水工程", "数字孪生流域", "天空地水工一体化监测", "深埋长隧洞TBM", "智慧灌区"],
        "business_segments": ["水利工程EPC业务", "管材与装备业务", "水务运营业务", "水利信息化业务"],
    },
    "新型电网": {
        "chain": "新型电网产业链",
        "segments": ["特高压主网", "智能变电", "配电与微网", "储能与调节", "电网数字化"],
        "bom_nodes": ["换流阀", "换流变压器", "GIS组合电器", "继电保护", "构网型储能", "调度自动化系统"],
        "technologies": ["特高压直流", "柔性直流", "构网型储能", "虚拟电厂", "源网荷储协同"],
        "business_segments": ["特高压设备业务", "配用电设备业务", "储能系统业务", "电网信息化业务"],
    },
    "算力网": {
        "chain": "算力网产业链",
        "segments": ["智算中心", "算力调度", "网络互联", "绿色算力"],
        "bom_nodes": ["AI服务器", "IDC/智算中心", "算力调度平台", "高速光模块", "液冷系统", "HVDC电源"],
        "technologies": ["东数西算", "全国一体化算力调度", "算力大通道", "液冷/绿电占比>80%", "算电协同"],
        "business_segments": ["IDC建设与运营业务", "算力调度与租赁业务", "光互联设备业务", "数据中心温控电源业务"],
    },
    "新一代通信网": {
        "chain": "新一代通信网产业链",
        "segments": ["5G-A接入", "万兆光网", "卫星互联网", "6G前瞻"],
        "bom_nodes": ["5G-A基站", "通感一体射频", "50G-PON/FTTR", "低轨卫星载荷", "相控阵天线", "太赫兹器件"],
        "technologies": ["5G-A/RedCap", "万兆光网50G-PON", "空天地一体", "通感一体", "6G/Pre6G"],
        "business_segments": ["基站设备业务", "光接入设备业务", "卫星通信业务", "通信测试业务"],
    },
    "城市地下管网": {
        "chain": "城市地下管网产业链",
        "segments": ["管材", "工程与修复", "监测与传感", "智慧管网"],
        "bom_nodes": ["球墨铸铁管/PE管", "非开挖修复装备", "燃气泄漏传感器", "管网巡检机器人", "综合管廊"],
        "technologies": ["非开挖修复", "环状网冗余设计", "管网数字孪生", "AI+机器人巡检"],
        "business_segments": ["管材业务", "市政管网工程业务", "管网监测设备业务", "智慧管网平台业务"],
    },
    "物流网": {
        "chain": "物流网产业链",
        "segments": ["枢纽与通道", "多式联运", "冷链物流", "智慧物流"],
        "bom_nodes": ["综合货运枢纽", "中欧班列/陆海新通道", "冷库与冷藏车", "无人仓/AGV", "数字货运平台"],
        "technologies": ["多式联运一单制", "6轴7廊8通道", "智慧仓储", "氢能重卡", "物流数字孪生"],
        "business_segments": ["物流枢纽运营业务", "多式联运业务", "冷链物流业务", "智慧物流装备业务"],
    },
    "AI算力": {
        "chain": "AI算力产业链",
