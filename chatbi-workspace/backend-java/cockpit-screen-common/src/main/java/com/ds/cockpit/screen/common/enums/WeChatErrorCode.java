...
public enum WeChatErrorCode {
    ...
    WeChatErrorCode(Integer errorCode, String errorDesc) {
        this.errorCode = errorCode;
        this.errorDesc = errorDesc;
    }

    public static String getErrorDesc(Integer errorCode) {
        for (WeChatErrorCode wxErrorCodeEnum : values()) {
    ...
    public static WeChatErrorCode errorCode(Integer code) {
        for (WeChatErrorCode value : values()) {
