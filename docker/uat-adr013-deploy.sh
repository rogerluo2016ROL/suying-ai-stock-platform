...
echo "  2. 启动 data-service: KRONOS_PG_URL=postgresql://kronos:kronos@localhost:16432/kronos TUSHARE_TOKEN=\$TUSHARE_TOKEN python -m uvicorn app.main:app --port 18010"
